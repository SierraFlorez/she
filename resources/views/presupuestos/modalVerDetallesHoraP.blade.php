<div class="modal fade" id="modalDetallesSolicitudPresupuesto" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col">
              ...
              <input readonly type="text" id="funcionario_pre" class="form-control validate">
              <input hidden type="text" id="cargo_user_pre" class="form-control validate">
            </div>
            {{-- Input de cargo --}}
            <div class="col">
              <i class="fas fa-tag"></i>
              <label data-error="wrong" data-success="right" for="orangeForm-name">Cargo Solicitud</label>
              <input readonly type="text" id="cargo_pre" class="form-control validate">
            </div>
          </div>
        </div>
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            ...
            <div class="col-6">
              ...
              <select class="form-control validate" id="th_solicitud_pre" name="tipohoras_s">
        ...
        <div class="md-form mb-4">
          ...
          <div class="form-row mb-6">
            <div class="col">
              ...
              <br>
              <select class="form-control validate" id="año_solicitud_pre" name="año_solicitud_s">
                <option value=""></option>
            ...
            <div class="col">
              ...
              <select class="form-control validate" id="mes_solicitud_pre" name="mes_solicitud_s">
                <option value=""></option>
        ...
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col">
              ...
              <input type="time" id="hora_inicio_pre" class="form-control validate">
            </div>
            {{-- Hora fin  --}}
            <div class="col">
              <i class="fas fa-clock"></i>
              <label data-error="wrong" data-success="right" for="orangeForm-pass">Hora Fin</label>
              <input type="time" id="hora_fin_pre" class="form-control validate">
            </div>
          </div>
        </div>
        ...
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col">
              ...
              <input readonly class="form-control validate" id="valor_total_pre">
            </div>
            {{-- Valor de hora  --}}
            <div class="col-6">
              <i class="fas fa-dollar-sign"></i>
              <label data-error="wrong" data-success="right" for="orangeForm-pass">Valor de Hora</label>
              <input readonly type="number" id="valor_hora_pre" class="form-control validate">
            </div>
          </div>
        </div>
        ...
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col">
              ...
              <input type="number" id="horas_pre" class="form-control validate">
            </div>
            {{-- Input autorizado --}}
            <div class="col">
              <i class="fas fa-user"></i>
              <label data-error="wrong" data-success="right" for="orangeForm-pass">Autorizado</label>
              <input readonly type="text" id="autorizado_pre" class="form-control validate">
            </div>
          </div>
        </div>
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col-md-6">
              ...
              <input readonly type="number" id="horas_restantes_pre" class="form-control validate">
            </div>
          </div>
        </div>
        {{-- Input Justificacion --}}
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col" style="margin-top:1%">
              ...
              <textarea class="form-control" id="actividades_pre" style="height:100%;"></textarea>
              <input hidden type="text" id="cargo_user_pre" class="form-control validate">
            </div>
          </div>
        </div>
