      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col-md-6">
              <i class="fas fa-user"></i>
              <label data-error="wrong" data-success="right" for="orangeForm-pass">Creado</label>
              <input readonly type="text" id="creado_s" class="form-control validate">
            </div>
            {{-- Input autorizado --}}
            <div class="col-md-6">
              <i class="fas fa-user"></i>
      ...
      <div class="modal-body mx-3">
        ...
        <div class="md-form mb-4">
          ...
          <div class="form-row mb-6">
            <div class="col-md-6">
              <i class="fas fa-clock"></i>
              <label data-error="wrong" data-success="right" for="orangeForm-pass">Cantidad de Horas</label>
              <input readonly type="number" id="horas_s" class="form-control validate">
            </div>
            {{-- Horas restantes --}}
            <div class="col-md-6">
              <i class="fas fa-clock"></i>
        ...
        <div class="md-form mb-4">
          <div class="form-row mb-6">
            <div class="col" style="margin-top:1%">
              <label data-error="wrong" data-success="right" for="orangeForm-name">Actividades:</label>
              <textarea readonly class="form-control" id="actividades_s" style="height:100%;"></textarea>
              <input readonly hidden type="text" id="cargo_user_s" class="form-control validate">
            </div>
          </div>
        </div>
      </div>
