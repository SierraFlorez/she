                ...
                <ul class="navbar-nav ml-auto navbar-right-top">
                    ...
                    <li class="nav-item dropdown nav-user" style="margin-right: 29px; border-right-width: 0px;" >
                        <a class="nav-link nav-user-img btn btn-secondary" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false"><i class="fa fa-tag" style="color:white"></i></a>
                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                            ...
                            <a class="dropdown-itemv"  onclick='detallesUsuarioCargoSesion({{Auth::user()->id}})' data-toggle="modal" href="#" 
                                data-target="#modalCuentaCargo"><i class="fas fa-user mr-2"></i>Cargo</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown nav-user" >
                        ...
                        <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                            ...
                            <a class="dropdown-item"  onclick='detallesUsuarioSesion({{Auth::user()->id}})' data-toggle="modal" href="#" 
                                data-target="#modalCuenta"><i class="fas fa-user mr-2"></i>Cuenta</a>
